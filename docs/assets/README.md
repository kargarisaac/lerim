...
- `lerim.png` is the Lerim mark: docs-site header logo and favicon, and the
  icon embedded in the public diagram illustrations (see
  lerim-context-compiler.svg etc.).
